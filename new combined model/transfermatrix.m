...
%
lambda=300:1:1200; % Wavelengths over which field patterns are calculated
...
layers = {'Air' 'glass' 'FTO'  'TiO2' 'perovskite' 'spiro'  'Si' 'SiOx'  }; % Names of layers of materials starting from side light is incident from

top=1000;  %% top cell thickness need to be alligned with transfermatrixtademtop

% thickness of each corresponding layer in nm (thickness of the first layer is irrelivant)


thicknesses = [0 100 700 50 top 200  100000 100 ];  % thickness of each corresponding layer in nm (thickness of the first layer is irrelivant)
...
plotGeneration = true;
activeLayer = 5; % index of material layer where photocurrent is generated
%
